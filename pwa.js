...
const cacheName = 'Assignment_4_Donovan_McGuire-2021-04-05 20:40:54.509355'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Assignment_4_Donovan_McGuire'.length) === 'Assignment_4_Donovan_McGuire') {
